<?php /* Smarty version 2.6.20, created on 2013-05-08 20:06:22
         compiled from admin/clothes/items/default.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'admin/includes/menu.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
			...
			<p class="breadcrum">
				...
				<a href="/admin/clothes/items/">Items</a>
				</p>
			<p class="linebreak"></p>
			<div id="main">
				<form id="detailsForm" name="detailsForm" action="/admin/clothes/items/" method="post">
					<div class="colsearch">
						<div class="article">
							<h4><a href="#">Name</a></h4>
				...
				<p class="linebreak"></p>
				<div class="clr"></div>
				<a class="link" href="/admin/clothes/items/details.php">Add an Items</a>
