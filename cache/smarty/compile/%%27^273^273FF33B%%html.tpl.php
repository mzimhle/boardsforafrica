<?php /* Smarty version 2.6.20, created on 2013-05-14 20:21:59
         compiled from admin/items/colours/html.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/items/colours/html.tpl', 13, false),)), $this); ?>
<!-- Start Content Table -->
<div class="content_table">
    <form name="htmlForm" id="htmlForm" action="#" method="post">
		<table id="grid_table" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <?php $_from = $this->_tpl_vars['clotheColoursItems']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
		  <tr>
			<td align="left" class="alt"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['colour_added'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>		
			<td align="left" class="alt"><a href="/admin/items/colours/details.php?reference=<?php echo $this->_tpl_vars['item']['pk_colour_id']; ?>
"><?php echo $this->_tpl_vars['item']['colour_name']; ?>
</a></td>	
			<td align="left" class="alt"><?php if ($this->_tpl_vars['item']['colour_active'] == '1'): ?><span class="success">Active</span><?php else: ?><span class="error">Non Active</span><?php endif; ?></td>
		  </tr>
		  <?php endforeach; else: ?>
			<tr>
