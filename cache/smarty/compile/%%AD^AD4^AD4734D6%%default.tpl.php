<?php /* Smarty version 2.6.20, created on 2013-05-16 00:58:36
         compiled from admin/items/items/default.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'admin/includes/menu.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
			...
			<p class="breadcrum">
				...
				<a href="/admin/items/items/">Items</a>
				</p>
			<p class="linebreak"></p>
			<div id="main">
				<form id="detailsForm" name="detailsForm" action="/admin/items/items/" method="post">
					<div class="colsearch">
						<div class="article">
							<h4><a href="#">Name</a></h4>
					...
					<div class="colsearch last">	
						<a class="link" href="javascript:send_filter(1);">Search Items</a>
					</div>				
				</form>
				<div class="clr"></div>
				<p class="linebreak"></p>
				<div class="clr"></div>
				<a class="link" href="/admin/items/items/details.php">Add an Items</a>
