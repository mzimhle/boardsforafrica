<?php /* Smarty version 2.6.20, created on 2013-05-14 20:21:29
         compiled from admin/items/products/html.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/items/products/html.tpl', 13, false),)), $this); ?>
<!-- Start Content Table -->
...
?>
		  <tr>
			...
			<td align="left" class="alt"><a href="/admin/items/products/details.php?reference=<?php echo $this->_tpl_vars['item']['pk_product_id']; ?>
"><?php echo $this->_tpl_vars['item']['product_name']; ?>
</a></td>	
			<td align="left" class="alt"><?php if ($this->_tpl_vars['item']['product_active'] == '1'): ?><span class="success">Active</span><?php else: ?><span class="error">Non Active</span><?php endif; ?></td>
		  </tr>
		  <?php endforeach; else: ?>
			<tr>
