<?php /* Smarty version 2.6.20, created on 2013-05-13 22:05:00
         compiled from admin/events/default.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'admin/includes/menu.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
			...
			<p class="linebreak"></p>
			<div id="main">
				<form id="detailsForm" name="detailsForm" action="/admin/events/" method="post">
					<div class="colsearch">
						<div class="article">
							<h4><a href="#">Name</a></h4>
							<input type="text" id="search_text" name="search_text~t"  event="20" value=""/>
						</div>
						</div>	
					<div class="colsearch">
						<div class="article">
					...
					<div class="colsearch last">	
						<a class="link" href="javascript:send_filter(1);">Search Events</a>
					</div>				
				</form>
				<div class="clr"></div>
				<p class="linebreak"></p>
				<div class="clr"></div>
				<a class="link" href="/admin/events/details.php">Add a Events</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="link" href="/admin/events/calendar.php">View Events in Calendar</a>
