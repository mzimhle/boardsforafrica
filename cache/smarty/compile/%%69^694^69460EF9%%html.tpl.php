<?php /* Smarty version 2.6.20, created on 2013-05-16 00:58:36
         compiled from admin/items/items/html.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/items/items/html.tpl', 16, false),)), $this); ?>
<!-- Start Content Table -->
...
?>
		  <tr>
			<td align="left" class="alt"><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['item_added'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>		
			<td align="left" class="alt"><a href="/admin/items/items/details.php?reference=<?php echo $this->_tpl_vars['item']['pk_item_id']; ?>
"><?php echo $this->_tpl_vars['item']['item_name']; ?>
</a></td>				
			<td align="left" class="alt"><?php echo $this->_tpl_vars['item']['item_code']; ?>
</td>	
			<td align="left" class="alt"><?php echo $this->_tpl_vars['item']['product_name']; ?>
</td>	
			<td align="left" class="alt"><?php echo $this->_tpl_vars['item']['brand_name']; ?>
</td>	
			<td align="left" class="alt"><?php if ($this->_tpl_vars['item']['item_active'] == '1'): ?><span class="success">Active</span><?php else: ?><span class="error">Non Active</span><?php endif; ?></td>
		  </tr>
		  <?php endforeach; else: ?>
			<tr>
